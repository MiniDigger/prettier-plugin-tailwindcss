...
let tests = [
  ...
  },
  {
    ...
    tests: {
      ...
      css: [
        [
          `.dum {\n@apply p-2 m-2 text-red-200 md:(bg-red-400 text-red-200 p-4 m-4) bg-blue-400;\n}`,
          `.dum {\n  @apply m-2 bg-blue-400 p-2 text-red-200 md:(m-4 bg-red-400 p-4 text-red-200);\n}`
        ],
        [
          `.dum {\n@apply p-2\nm-2\ntext-red-400\nmd:(bg-white text-red-200 p-4 m-4)\nbg-black;\n}`,
          `.dum {\n  @apply m-2\nbg-black\np-2\ntext-red-400\nmd:(m-4 bg-white p-4 text-red-200);\n}`
        ]
      ]
    }
  },
